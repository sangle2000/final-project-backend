...
from graphql_module.mutations import SignUp, Login, UpdateProfile, AddProduction, AddItemToCart, DeleteItemInCart
...
class Mutation(graphene.ObjectType):
    ...
    addItemToCart = AddItemToCart.Field()
    deleteItemInCart = DeleteItemInCart.Field()
